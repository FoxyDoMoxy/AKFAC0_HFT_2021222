...
namespace AKFAC0_HFT_2021222.Repository
{
	public partial class JobDbContext : DbContext
	{
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			{
				new Armor(1,"Reverence SET",250,1),
				new Armor(2,"Pummeler's SET",212,2),
				new Armor(3,"Ignominy SET",234,3),
				new Armor(4,"Allegiance SET",243,4),
				new Armor(5,"Theophany SET",49,5),
				new Armor(6,"Academic's SET",23,6),
				new Armor(7,"Astronomia SET",30,7),
				new Armor(8,"Didact's SET",34,8),
				new Armor(9,"Tiamat SET",150,9),
				new Armor(10,"Anchorite's SET",122,10),
				new Armor(11,"Hachiya SET",130,11),
				new Armor(12,"Reaper's SET",120,12),// randomize innen még
